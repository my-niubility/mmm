...
@Controller
public class RepayQueryController {
	...
	@RequestMapping(value = "/repayQuery", method = { RequestMethod.POST, RequestMethod.GET })
	public String query(HttpServletRequest request, HttpServletResponse response) {
		logger.info("/repayQuery===");
		...
		return "/WEB-INF/view/trade/repay_query_body";
	}

	@SuppressWarnings("unchecked")
	@RequestMapping(value = "/repayPageList", method = { RequestMethod.POST, RequestMethod.GET })
	...
	@RequestMapping(value = "/toRepayMain", method = { RequestMethod.POST, RequestMethod.GET })
	public String queryMain(HttpServletRequest request, HttpServletResponse response) {
		logger.info("/toRepayMain===");
		repayStatus = request.getParameter("repayStatus");
		return "/WEB-INF/view/trade/repay_query_main";

	}

	@RequestMapping(value = "/repay_query_top", method = { RequestMethod.POST, RequestMethod.GET })
	public String queryTop(HttpServletRequest request, HttpServletResponse response) {
		logger.info("/repay_query_top===");
		return "/WEB-INF/view/trade/repay_query_top";

	}

	@RequestMapping(value = "/repay_query_body", method = { RequestMethod.POST, RequestMethod.GET })
	public String queryBody(HttpServletRequest request, HttpServletResponse response) {
		logger.info("/repay_query_body===");
	...
	@RequestMapping(value = "/repayDetail", method = { RequestMethod.POST, RequestMethod.GET })
	public String queryDetail(HttpServletRequest request, HttpServletResponse response) {
		...
		return "/WEB-INF/view/trade/repay_query_detail";
	}

	@RequestMapping(value = "/investorsQuery", method = { RequestMethod.POST, RequestMethod.GET })
	...
	@SuppressWarnings("unchecked")
	@RequestMapping(value = "/incomeList", method = { RequestMethod.POST, RequestMethod.GET })
	public String queryIncomePage(HttpServletRequest request, HttpServletResponse response) {
		logger.info("/incomeList===");
	...
	@RequestMapping(value = "/repayApply", method = { RequestMethod.POST, RequestMethod.GET })
	public String repayApply(HttpServletRequest request, HttpServletResponse response) {
		logger.info("/repayApply===");
		// 调用第三方接口还款
		String productId = request.getParameter("productId");//产品ID
		String id = request.getParameter("id");//产品期次ID
		boolean flag = tradeService.repayUpdate(productId,id);
		if(flag){
			//成功
